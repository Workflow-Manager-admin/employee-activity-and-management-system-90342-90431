        ...
        >
          ...
          >
            <div className="grid-2" style={{ gap: 36, marginBottom: 10 }}>
              {/* Employee Number */}
              <div>
                <label style={{ fontWeight: 700, fontSize: "1.08em" }}>
                  Employee Number
                </label>
                <input
                  className="input"
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Employee Name <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <input
                  className="input"
                  style={{ marginTop: 9 }}
                ...
                {errors.name && touched.name && (
                  <div style={{ color: "var(--accent-pink)", fontSize: ".99em", marginTop: -13 }}>
                    {errors.name}
                  </div>
                )}
              </div>
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Email <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <input
                  className="input"
                  style={{ marginTop: 9 }}
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Phone Number <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <input
                  className="input"
                  style={{ marginTop: 9 }}
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Date of Birth <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <input
                  className="input"
                  style={{ marginTop: 9 }}
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Gender <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <select
                  className="select"
                  style={{ marginTop: 9 }}
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Department <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <select
                  className="select"
                  style={{ marginTop: 9 }}
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Designation <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <select
                  className="select"
                  style={{ marginTop: 9 }}
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Joining Date <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <input
                  className="input"
                  style={{ marginTop: 9 }}
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Role <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <select
                  className="select"
                  style={{ marginTop: 9 }}
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Manager/Supervisor <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <input
                  className="input"
                  style={{ marginTop: 9 }}
              ...
              <div>
                <label style={{ fontWeight: 700 }}>
                  Work Location <span style={{ color: "var(--accent-pink)" }}>*</span>
                </label>
                <select
                  className="select"
                  style={{ marginTop: 9 }}
          ...
          <div
            ...
            style={{
              ...
              left: 0,
              background: "var(--bg-canvas)",
              boxShadow: "0 -2px 24px rgba(37,72,138,0.08)",
              padding: "22px 38px",
              display: "flex",
              flexDirection: "row",
